...
\begin{table}[hbt]
  ...
  \begin{tabular}{c|c|c|c|c|c}
    ...
    3 & Medio & Medio & Bajo & 8 & Alta\\ \hline
  ...
  \item \textbf{Épica 1: adquisición de datos}
    \begin{itemize}
      ...
      \item HU3 - herramienta de procesamiento de archivos INPUT/OUTPUT:
        \begin{itemize}
          \item Herramienta que permita procesar en batch archivos INPUT/OUTPUT, obteniendo un único archivo de fácil importación luego (p.e.: .csv, .json, etc.).
...
\begin{enumerate}
  \item \textbf{Comprensión del negocio:}
    \begin{itemize}
      \item Objetivo: desarrollar una herramienta de predicción basade en aprendizaje profundo para predecir las potencias límite de canal de CNA-II con un menor costo computacional al método actual con COBRA-3CP.
...
\multirow{3}{4cm}{HU1 - determinación del set de datos}  
  ...
  & 1.2: Documentación de casos contemplados por las simulaciones ya hechas y cataloguización de los mismos. & 1 h & Alta \\ \cline{2-4}
...
\multirow{3}{4cm}{HU5 - modelo básico documentado}  
  ...
  & 5.3: Armado de versión entrenada en github de modelo & 2 h & Alta \\ \hline
...
\multirow{2}{4cm}{HU7 - figuras de mérito}  
  ...
  & 7.2: Documentación de efecto de las figuras de mérito en las PLC  & 2 h & Baja \\ \cline{2-4}
\multirow{3}{4cm}{HU8 - estudio de redes neuronales informadas por física}  
  ...
  & 8.3: Aplicación de ejemplos básicos de redes neuronales informadas por física & 4 h & Alta \\ \hline
\multirow{5}{4cm}{HU9 - implementación de redes neuronales informadas por física}  
  & 9.1: Definición de las ecuaciones a aplicar en el modelo  & 3 h & Media \\ \cline{2-4}
  & 9.1: Armado de modelo base de red neuronal informada por física con las ecuaciones definidas & 6 h & Media \\ \cline{2-4}
  & 9.2: Análisis de hiperparámetros y arquitecturas & 10 h & Media \\ \cline{2-4}
  & 9.3: Definición de red neuronal informada por física final & 2 h & Media \\ \cline{2-4}
  & 9.4: Comparativa de performance contra modelos previamente desarrollados & 3 h & Media \\ \cline{2-4}
  & 9.5: Documentación final de modelo final de red neuronal informada por física & 2 h & Media \\ \hline
% \end{tabularx}
\end{longtable}
% \end{table}
