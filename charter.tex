...
\begin{itemize}
  \item No se incluiran datos del diseño del reactor en el dataset creado a partir de los OUTPUT de COBRA.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Severidad (S): 10. Implicaría tener que realizar una cantidad de simulaciones muy grande, lo cual retrasaría significativamente el proyecto.
    ...
    \begin{itemize}
        \item Severidad (S): 8. Implicaría tener que entrenar los modelos en servicios en la nube gratuitos, los cuales tienen límites bajos, impactando en el tiempo total dedicado a entrenar.
        \item Probabilidad de ocurrencia (O): 2. Se dispone de mi computadora personal con GPU y de la computadora de mi empleo asignada a mí con GPU. Adicionalmente se puede disponer del uso de las computadoras de mis compañeros de trabajo para entrenar fuera de los horarios de oficina. La probabilidad de la indisponibilidad de todos los recursos computacionales de forma simultánea es baja.
    \end{itemize}
    \item Riesgo 3: No se dicta la materia ``Redes Neuronales Informadas por Física" durante el 2026.
    \begin{itemize}
        \item Severidad (S): 7. Implicaría tener que aprender sobre redes neuronales informadas por física por mi cuenta, lo cual retrasaría significativamente el proyecto.
    ...
    \begin{itemize}
        ...
        \item Probabilidad de ocurrencia (O): 3. Se tiene conocimiento de algunas figuras de mérito ya establecidas, por lo que al menos encontrar la relación exacta de ellas puede realizarse. Adicionalmente el trabajo tiene por objetivo la evaluación de nuevas figuras de mérito, lo cual podría no ser posible.
    \end{itemize}
...
Incapacidad de localizar suficientes archivos de OUTPUT de simulaciones ya realizadas. & 10 & 2 & 20 &   &   &      \\ \hline
...
\begin{tabular}{p{4cm}p{2cm}p{4.5cm}p{4.5cm}p{4.5cm}}
...
Sprint técnico (N1) & Ser detallado en los casos necesarios. Buscar y guardar de forma ordenada los archivos. & Ver el detalle de cada archivo, se va a post-procesar y filtrar luego. & El orden de los archivos. & Reuniones alumno-director para no perder el eje del trabajo. & Irse por las ramas en temas no centrales. \\ \hline
Sprint técnico (N2) & Guardar todos los archivos de procesado de forma ordenada en un repositorio. & Buscar armar la herramienta perfecta de procesado. & Reuniones alumno-director. & Escribir las partes de la memoria que ya estén definidas. & Perfeccionar el código de forma innecesaria. \\ \hline
Sprint técnico (N8) & Documentar las pruebas realizadas. & Re-entrenar el modelo con parámetros ya usados. & Escritura de la memoria. & Ordenar todos los modelos probados para su comparativa. & Demasiadas comparativas entre modelos que no se entiendan. \\ \hline
Sprint no técnica (N12) & Práctica de la presentación con compañeros de trabajo. & Buscar sacarle más rendimiento a los modelos. & Gráficos representativos. & Definir las partes de la presentación. & Sumar información a la memoria y la presentación. \\ \hline
\end{tabular}%
\end{table}
\end{landscape}
